        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <RevealOnScroll delay={100}>
            <div className="group relative p-8 rounded-2xl bg-card border border-border hover:border-border transition-all duration-500 hover:shadow-[0_8px_40px_-12px_rgba(0,0,0,0.08)]">
              <div className="mb-6">
                <div className="w-10 h-10 rounded-lg bg-foreground text-background flex items-center justify-center transition-all duration-300 group-hover:rotate-6 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-foreground/10">
