    ...
    <article>
      ...
      <div className="prose-fibor">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-8 not-prose">
          <a href="/docs/fibor-id" className="group p-5 rounded-xl border border-border bg-muted/50 hover:border-border transition-all duration-300 block">
            <div className="w-10 h-10 rounded-lg bg-foreground text-background flex items-center justify-center mb-3 transition-all duration-300 group-hover:rotate-6 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-foreground/10">
          ...
          <a href="/docs/fibor-score" className="group p-5 rounded-xl border border-border bg-muted/50 hover:border-border transition-all duration-300 block">
            <div className="w-10 h-10 rounded-lg bg-foreground text-background flex items-center justify-center mb-3 transition-all duration-300 group-hover:-rotate-6 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-foreground/10">
              <svg width="16" height="16" viewBox="0 0 14 14" fill="none">
          ...
          <a href="/docs/fibor-credit" className="group p-5 rounded-xl border border-border bg-muted/50 hover:border-border transition-all duration-300 block">
            <div className="w-10 h-10 rounded-lg bg-foreground text-background flex items-center justify-center mb-3 transition-all duration-300 group-hover:rotate-12 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-foreground/10">
              <svg width="16" height="16" viewBox="0 0 14 14" fill="none">
